...
@RestController
@RequestMapping("/api/cem-suite-kafka")
public class CemSuiteKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CemSuiteKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CemSuiteKafkaResource(KafkaProperties kafkaProperties) {
